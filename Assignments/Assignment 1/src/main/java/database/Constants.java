...
public class Constants {
    ...
    public static class AccountTypes {
        ...
        public static final String[] TYPES={DEBIT, CREDIT};
    }
    ...
    public static class Tables {
        ...
        public static final String[] ORDERED_TABLES_FOR_CREATION = new String[]{USER, ROLE, RIGHT, ROLE_RIGHT, USER_ROLE,TYPE, CLIENT,  ACCOUNT, BILL, HISTORY};
    }
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{CREATE_USER, DELETE_USER, UPDATE_USER, CREATE_CLIENT, DELETE_CLIENT, UPDATE_CLIENT
                , CREATE_ACCOUNT, DELETE_ACCOUNT, UPDATE_ACCOUNT,TRANSFER, PROCESS_BILLS, VIEW_LOG};
    }
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(CREATE_CLIENT, DELETE_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT, DELETE_ACCOUNT, UPDATE_ACCOUNT, TRANSFER, PROCESS_BILLS));
